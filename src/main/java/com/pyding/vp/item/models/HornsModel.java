...
public class HornsModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "horns"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int i3) {
		main2.render(poseStack, vertexConsumer, packedLight, packedOverlay, i3);
		main3.render(poseStack, vertexConsumer, packedLight, packedOverlay, i3);
	}
}