...
public class ConfigHandler {
    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            lootDrops = builder.comment("Loot tables for Mystery Chest common/rare/mystic/legendary. All chances are independent so 0.7(70% chance) on common cause dropping air in 30% cases.").define("lootDrops","1<item.vp.box_saplings,item.irons_spellbooks.blank_rune4,item.irons_spellbooks.rare_ink5,block.minecraft.wither_skeleton_skull3,item.minecraft.end_crystal4,item.minecraft.totem_of_undying,item.minecraft.netherite_scrap4,block.aether.enchanted_gravitite8,item.irons_spellbooks.arcane_salvage4,item.rats.plague_tome>0.24<item.vp.shard,item.vp.stellar,item.vp.corrupted_fragment,item.aquamirae.ship_graveyard_echo8,item.enigmaticlegacy.earth_heart,item.enigmaticlegacy.etherium_ore5,item.skilltree.wisdom_scroll4,block.occultism.storage_stabilizer_tier3,item.celestisynth.supernal_netherite_ingot8,item.enigmaticlegacy.angel_blessing,item.enigmaticlegacy.ocean_stone,item.enigmaticlegacy.blazing_core,item.enigmaticlegacy.eye_of_nebula,item.irons_spellbooks.lightning_upgrade_orb,item.irons_spellbooks.ice_upgrade_orb,item.irons_spellbooks.protection_upgrade_orb,item.irons_spellbooks.mana_upgrade_orb,item.irons_spellbooks.ender_upgrade_orb,item.irons_spellbooks.cooldown_upgrade_orb,item.irons_spellbooks.nature_upgrade_orb,item.irons_spellbooks.evocation_upgrade_orb,item.irons_spellbooks.fire_upgrade_orb,item.irons_spellbooks.holy_upgrade_orb,item.irons_spellbooks.blood_upgrade_orb,item.irons_spellbooks.epic_ink5,item.vp.stellar2,item.vp.stellar3>0.059<item.vp.hearty_pearl,item.vp.vortex,item.vp.seashell,item.vp.corrupted_item,item.enigmaticlegacy.cosmic_heart,item.aquamirae.abyssal_amethyst8,item.enigmaticlegacy.astral_fruit,item.enigmaticlegacy.ichor_bottle,item.enigmaticlegacy.void_pearl,item.irons_spellbooks.legendary_ink5,item.vp.stellar8,item.vp.stellar9,item.vp.stellar10,item.vp.stellar11,item.vp.stellar12,block.occultism.storage_stabilizer_tier4,item.vp.chaos_orb,block.minecraft.dragon_egg,item.twilightforest.charm_of_keeping_64>0.001<item.vp.chaos_orb5,item.vp.celestial_mirror,item.vp.pinky_pearl,item.enigmaticlegacy.the_cube>");
        }
