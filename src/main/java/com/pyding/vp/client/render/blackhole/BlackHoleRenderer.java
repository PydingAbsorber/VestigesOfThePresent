...
public class BlackHoleRenderer extends EntityRenderer<BlackHole> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(VestigesOfThePresent.MODID,"textures/item/models/blackholepallet.png");
