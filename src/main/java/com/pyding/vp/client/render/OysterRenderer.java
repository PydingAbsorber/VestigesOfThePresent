...
public class OysterRenderer extends EntityRenderer<HungryOyster> {
    public static final ResourceLocation PINK_PEARL = ResourceLocation.fromNamespaceAndPath(VestigesOfThePresent.MODID,"textures/models/pearl.png");
    public static final ResourceLocation PEARL = ResourceLocation.fromNamespaceAndPath(VestigesOfThePresent.MODID,"textures/models/common_pearl.png");
    public static final ResourceLocation MAIN = ResourceLocation.fromNamespaceAndPath(VestigesOfThePresent.MODID,"textures/models/oyster_texture.png");
